...
#%%
project_dir = r"E:\!hh.ru\vacancies_pickle_all_2020"

src_dir = f"{project_dir}\src_dir"
dst_dir = f"{project_dir}\dst_dir"
...
for filename_pkl in tqdm(files):
    ...
    filename_zip = filename_pkl.replace(src_dir, dst_dir).replace('.pkl', '.zip')
